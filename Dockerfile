...
RUN /opt/keycloak/bin/kc.sh build --health-enabled=true --metrics-enabled=true  --tracing-enabled=true --features=token-exchange,opentelemetry-logs --tracing-enabled=true
