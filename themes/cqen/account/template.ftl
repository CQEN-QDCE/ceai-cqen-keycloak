    ...
    <header class="navbar navbar-default navbar-pf navbar-main header">
        <nav class="navbar" role="navigation">
            <div class="navbar-header">
                <div class="container">
                    <img id="brand" alt="Logo du gouvernement du Québec." src="${url.resourcesPath}/img/QUEBEC_blanc.svg" width="250" height="75.13"></a>
                    <span class="text">${kcSanitize(realm.displayNameHtml)?no_esc}</span>
                </div>
            </div>
